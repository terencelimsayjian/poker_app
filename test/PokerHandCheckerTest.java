...
public class PokerHandCheckerTest {
    ...
    @Test
    public void testStraightIsNotStraightFlush () {
        ArrayList<Card> board = new ArrayList<Card>(5);
        Card c1 = new Card(6, 1);
        Card c2 = new Card(7, 1);
        Card c3 = new Card(8, 4);
        Card c4 = new Card(2, 2);
        Card c5 = new Card(3, 3);
        Card c6 = new Card(9, 1);
        Card c7 = new Card(10, 1);
    ...
    @Test
    public void testFlushIsNotStraightFlush () {
        ArrayList<Card> board = new ArrayList<Card>(5);
        Card c1 = new Card(7, 1);
        Card c2 = new Card(8, 1);
    ...
    @Test
    public void testSixCardStraightFlush () {
        ArrayList<Card> board = new ArrayList<Card>(5);
        Card c1 = new Card(6, 1);
        Card c2 = new Card(7, 1);
        Card c3 = new Card(8, 1);
    ...
    @Test
    public void testPairWithStraightIsStraight () {
        ArrayList<Card> board = new ArrayList<Card>(5);
        board.add(0, new Card(2, 1));
        board.add(1, new Card(3, 2));
        board.add(2, new Card(4, 3));
    ...
    @Test
    public void testFlushIsNotThreeOfAKind () {
        ArrayList<Card> board = new ArrayList<Card>(5);
        board.add(0, new Card(7, 1));
        board.add(1, new Card(7, 2));
        board.add(2, new Card(7, 3));
        board.add(3, new Card(1, 1));
        board.add(4, new Card(2, 1));
    ...
    @Test
    public void testStraightIsNotThreeOfAKind () {
        ArrayList<Card> board = new ArrayList<Card>(5);
        board.add(0, new Card(7, 1));
        board.add(1, new Card(7, 2));
        board.add(2, new Card(7, 3));
        board.add(3, new Card(3, 4));
        board.add(4, new Card(4, 1));
    ...
    @Test
    public void testQuadsAndTripsIsNotThreeOfAKind () {
        ArrayList<Card> board = new ArrayList<Card>(5);
        board.add(0, new Card(7, 1));
        board.add(1, new Card(7, 2));
        board.add(2, new Card(7, 3));
        board.add(3, new Card(12, 4));
        board.add(4, new Card(12, 1));
    ...
    @Test
    public void testFlushIsNotTwoPair () {
        Card c1 = new Card(7, 1);
        Card c2 = new Card(7, 2);
    ...
    @Test
    public void testStraightIsNotTwoPair () {
        Card c1 = new Card(7, 1);
        Card c2 = new Card(8, 2);
        Card c3 = new Card(9, 3);
        Card c4 = new Card(10, 4);
    ...
    @Test
    public void testFullHouseIsNotTwoPair () {
        ArrayList<Card> board = new ArrayList<Card>(5);
        board.add(0, new Card(7, 1));
        board.add(1, new Card(7, 2));
        board.add(2, new Card(7, 3));
        board.add(3, new Card(8, 4));
        board.add(4, new Card(8, 1));
    ...
    @Test
    public void testQuadsIsNotTwoPair () {
        ArrayList<Card> board = new ArrayList<Card>(5);
        board.add(0, new Card(7, 1));
        board.add(1, new Card(7, 2));
        board.add(2, new Card(7, 3));
        board.add(3, new Card(7, 4));
        board.add(4, new Card(1, 1));
    ...
    @Test
    public void testNoPairIsNotPair () {
        ArrayList<Card> board = new ArrayList<Card>(5);
        board.add(0, new Card(7, 1));
        board.add(1, new Card(8, 2));
        board.add(2, new Card(9, 3));
    ...
    @Test
    public void testStraightFlushIsNotPair () {
        ArrayList<Card> board = new ArrayList<Card>(5);
        board.add(0, new Card(7, 1));
        board.add(1, new Card(8, 1));
        board.add(2, new Card(9, 1));
        board.add(3, new Card(10, 1));
        board.add(4, new Card(1, 2));
    ...
    @Test
    public void testFlushIsNotPair () {
        ArrayList<Card> board = new ArrayList<Card>(5);
        board.add(0, new Card(1, 3));
        board.add(1, new Card(3, 3));
        board.add(2, new Card(5, 3));
        board.add(3, new Card(7, 3));
        board.add(4, new Card(9, 1));
    ...
    @Test
    public void testStraightIsNotPair () {
        ArrayList<Card> board = new ArrayList<Card>(5);
        board.add(0, new Card(1, 1));
        board.add(1, new Card(2, 2));
        board.add(2, new Card(3, 3));
        board.add(3, new Card(4, 4));
        board.add(4, new Card(5, 1));
    ...
    @Test
    public void testStraightFlushIsNotHighCard () {
        ArrayList<Card> board = new ArrayList<Card>(5);
        board.add(0, new Card(7, 1));
        board.add(1, new Card(8, 1));
        board.add(2, new Card(9, 1));
    ...
    @Test
    public void testFlushIsNotHighCard () {
        ArrayList<Card> board = new ArrayList<Card>(5);
        board.add(0, new Card(1, 3));
        board.add(1, new Card(3, 3));
        board.add(2, new Card(5, 3));
    ...
    @Test
    public void testStraightIsNotHighCard () {
        ArrayList<Card> board = new ArrayList<Card>(5);
        board.add(0, new Card(6, 1));
        board.add(1, new Card(2, 2));
        board.add(2, new Card(3, 3));
    ...
    @Test
    public void testTwoHighCardIsNotHighCard () {
        ArrayList<Card> board = new ArrayList<Card>(5);
        board.add(0, new Card(1, 1));
        board.add(1, new Card(1, 2));
        board.add(2, new Card(2, 3));
    ...
    @Test
    public void testhasStraightStartingWithAce() {
        ArrayList<Card> board = new ArrayList<Card>(5);
        board.add(0, new Card(1, 1));
        board.add(1, new Card(2, 2));
        board.add(2, new Card(3, 3));
    ...
    @Test
    public void testhasStraightStartingWithAce2() {
        ArrayList<Card> board = new ArrayList<Card>(5);
        board.add(0, new Card(1, 1));
        board.add(1, new Card(2, 2));
        board.add(2, new Card(3, 3));
