...
public class Main {
    ...
    public static void main(String[] args) {
            ...
            hand1.add(deck.dealCard());
            System.out.println("com.pokerapp.models.Player 1: " + hand1.toString());

            ArrayList<Card> hand2 = new ArrayList<Card>(2);
            hand2.add(deck.dealCard());
            hand2.add(deck.dealCard());
            System.out.println("com.pokerapp.models.Player 2: " + hand2.toString());

            ArrayList<Card> hand3 = new ArrayList<Card>(2);
            hand3.add(deck.dealCard());
            hand3.add(deck.dealCard());
            System.out.println("com.pokerapp.models.Player 3: " + hand3.toString());

            ArrayList<Card> hand4 = new ArrayList<Card>(2);
            hand4.add(deck.dealCard());
            hand4.add(deck.dealCard());
            System.out.println("com.pokerapp.models.Player 4: " + hand4.toString());

            ArrayList<Card> hand5 = new ArrayList<Card>(2);
            hand5.add(deck.dealCard());
            hand5.add(deck.dealCard());
            System.out.println("com.pokerapp.models.Player 5: " + hand5.toString());

            ArrayList<Card> hand6 = new ArrayList<Card>(2);
            hand6.add(deck.dealCard());
            hand6.add(deck.dealCard());
            System.out.println("com.pokerapp.models.Player 6: " + hand6.toString());
            ...
            System.out.println("com.pokerapp.models.Player 1 has a " + pokerHand1.toString());
            System.out.println("com.pokerapp.models.Player 2 has a " + pokerHand2.toString());
            System.out.println("com.pokerapp.models.Player 3 has a " + pokerHand3.toString());
            System.out.println("com.pokerapp.models.Player 4 has a " + pokerHand4.toString());
            System.out.println("com.pokerapp.models.Player 5 has a " + pokerHand5.toString());
            System.out.println("com.pokerapp.models.Player 6 has a " + pokerHand6.toString());
